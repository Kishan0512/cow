...
part of 'Breeding_reproduction_id.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class BreedingreproductionidAdapter
    extends TypeAdapter<Breeding_reproduction_id> {
  @override
  final int typeId = 41;

  @override
  Breeding_reproduction_id read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return Breeding_reproduction_id(
      ...
      id: fields[39] as dynamic,
      SyncStatus: fields[40] as dynamic,
      CI: fields[41] as dynamic,
      Sirename: fields[42] as dynamic,
      insertflag: fields[43] as dynamic,
      AIDays: fields[44] as dynamic,
      CalvingPDDays: fields[45] as dynamic,
      AITname: fields[46] as dynamic,
      PDname: fields[47] as dynamic,
      PDResult: fields[48] as dynamic,
      PDdays: fields[49] as dynamic,
      Pregdays: fields[50] as dynamic,
      hI: fields[51] as dynamic,
      zone: fields[52] as dynamic,
      aICost: fields[53] as dynamic,
      createdAt: fields[54] as dynamic,
      createdByUser: fields[57] as dynamic,
      lastUpdatedByUser: fields[56] as dynamic,
      ServerId: fields[58] as dynamic,
      TableNAme: fields[59] as dynamic,
      updatedAt: fields[55] as dynamic,
    );
  }

  @override
  void write(BinaryWriter writer, Breeding_reproduction_id obj) {
    writer
      ..writeByte(60)
      ..writeByte(0)
      ..write(obj.tagId)
      ...
      ..write(obj.Sirename)
      ..writeByte(43)
      ..write(obj.insertflag)
      ..writeByte(44)
      ..write(obj.AIDays)
      ..writeByte(45)
      ..write(obj.CalvingPDDays)
      ..writeByte(46)
      ..write(obj.AITname)
      ..writeByte(47)
      ..write(obj.PDname)
  ...
  bool operator ==(Object other) =>
      ...
      other is BreedingreproductionidAdapter &&
