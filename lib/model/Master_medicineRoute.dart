...
part 'Master_medicineRoute.g.dart';

@HiveType(typeId: 21)
class Master_medicineRoute extends HiveObject {
  @HiveField(0)
  String name;
  @HiveField(1)
  int id;
  ...
  Master_medicineRoute.fromJson(Map<String, dynamic> json)
      : name = json['Name'] ?? "",
        id = json['ID'] ?? 0,
  ...
  static Map<String, dynamic> toJson(Master_medicineRoute h) {
    return {
      'Name': h.name,
      'ID': h.id,
