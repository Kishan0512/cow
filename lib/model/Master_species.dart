...
part 'Master_species.g.dart';

@HiveType(typeId: 2)
class Master_species extends HiveObject {
  @HiveField(0)
  String name;
  @HiveField(1)
  int id;
  ...
  Master_species.fromJson(Map<String, dynamic> json)
      : name = json['Name'] ?? "",
        id = json['id'] ?? 0,
  ...
  static Map<String, dynamic> toJson(Master_species h) {
    return {
      'Name': h.name,
      'id': h.id,
